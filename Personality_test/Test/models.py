...
class userSelection(models.Model):
    ...
    q1 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q2 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q3 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q4 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q5 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q6 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q7 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q8 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q9 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q10 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q11 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q12 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q13 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q14 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q15 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q16 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q17 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q18 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q19 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q20 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q21 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q22 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q23 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q24 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q25 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q26 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q27 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q28 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q29 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q30 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q31 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q32 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q33 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q34 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q35 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q36 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q37 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q38 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q39 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q40 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q41 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q42 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q43 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q44 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q45 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q46 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q47 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q48 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q49 = models.CharField(max_length=2, choices=CHOICES, blank=True)
    q50 = models.CharField(max_length=2, choices=CHOICES, blank=True)
